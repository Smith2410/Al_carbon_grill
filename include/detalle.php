    ...
    <div class="container-fluid">
        ...
        <div class="row">
                ...
                <table class="table table-striped">
                    <tbody>
                        <?php
                            ...
                            if($ventaInf['Adjunto']!="" && is_file("./assets/img-products/".$ventaInf['Adjunto']))
                            {
                                $adjuntoFile="./assets/img-products/".$ventaInf['Adjunto']; 
                            }else{ 
                                $adjuntoFile="./assets/img-products/default.png"; 
                            }
                        ?>
                        <tr>
                            <td>Fecha</td>
            ...
            <div class="col-lg-4 text-center">
                <?php 
                    if(is_file("./assets/comprobantes/".$ventaInf['Adjunto']))
                    {
                        ?>
                        <label>Adjunto</label><br>
                        <a href="./assets/comprobantes/<?php echo $ventaInf['Adjunto']; ?>" target="_blank" class="btn btn-outline-warning">
                            <img style="width:250px; height: 250px;" src="./assets/comprobantes/<?php echo $ventaInf['Adjunto']; ?>">
                        </a>
                        <?php
                    }else{
                        ?>
        ...
        <br>
            <div class="text-center">
                <a href="report/factura.php?id=<?php echo $ventaInf['NumPedido'];?>" target="_blank" class="book-a-table-btn scrollto">Descargar Factura</a>
                <div class="d-lg-none">
                    <br>
                </div>
                <a href="<?php echo $volver; ?>" class="book-a-table-btn scrollto">Volver</a>
            </div>
        </br>
    </div>
</div>