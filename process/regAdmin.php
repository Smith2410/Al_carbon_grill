...
$userAdmin=consultasSQL::clean_string($_POST['admin-user']);
...
$verificar=ejecutarSQL::consultar("SELECT * FROM administrador WHERE Usuario='".$userAdmin."'");
if(mysqli_num_rows($verificar)<=0){
    if(consultasSQL::InsertSQL("administrador", "DNI, Nombre, Apellidos, Telefono, Direccion, Usuario, Clave", "'$dniAdmin','$nomAdmin','$apeAdmin','$telAdmin','$dirAdmin','$userAdmin','$passAdminFinal'")){
        echo '<script>
            swal({
